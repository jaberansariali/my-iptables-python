...
import sys
############################################Discription###################################
# This the input parameter  1#Ch:input/output  2#Po:tcp/udp/all  3#: interface/all 4#S:ip/subnet or all 5#D:ip/subnet or all 6#SP:portnumber/all 7#DP:portnumber/all 8#ACCEPT/DROP
if len(sys.argv) > 9:
...
if Chain == "input":
   ...
   Chain = "OUTPUT"
if protocol == "all" or protocol == "ALL" :
   protocol = ""
